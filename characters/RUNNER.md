...
- **Skin tone:** Vary it across spawns — the Block's neighborhood mix should show.
- **Body language:** Cocky on approach, panicked when hit. Knees bent forward, hands raised but loose.
- **Face:** Young. Some have stubble, some don't. Don't show fear in idle — show it in `hurt`.

## Hair

- Short, varied — buzz cuts, fades, beanie-covered. Each Runner spawn should pick from a small palette of looks (use a sprite-sheet variation system or 2–3 alternates).
